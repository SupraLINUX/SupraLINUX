...
for node_id,sha in expected.items():
    ...
    req(planning.get("readiness")=="package-contract-tree-pass",f"{node_id}: package-contract tree PASS lifecycle")
    ...
    req(planning.get("package_contract")=="packaging-tree-pass",f"{node_id}: package-contract packaging-tree PASS")
...
req(policy.get("phase")=="package-contract-review","Tier3 discovery phase")
...
req(policy.get("package_contracts")=="packaging-tree-pass-review-required","Tier3 package-contract gate")
req(policy.get("package_builds")=="not-authorized-before-tier3-package-contract-review","Tier3 package-build gate")
...
req(support.get("next_gate")=="tier3-package-contract-review","Tier3 support next gate")
...
req("package-contract-tree-pass" in doc,"Tier3 docs lifecycle")
...
print("Next gate: Tier 3 package-contract review")
