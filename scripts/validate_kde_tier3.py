...
for node_id,sha in expected.items():
    ...
    req(planning.get("readiness")=="package-contract-review-pending",f"{node_id}: package-contract review-pending lifecycle")
    ...
    req(planning.get("package_contract")=="review-pending",f"{node_id}: package-contract review pending")
...
req(policy.get("package_contracts")=="contract-review-pending","Tier3 package-contract gate")
...
req("package-contract-review-pending" in doc,"Tier3 docs lifecycle")
