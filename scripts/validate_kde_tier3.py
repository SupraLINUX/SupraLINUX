...
req(policy.get("package_builds")=="support-build-level0-authorized","Tier3 package-build gate")
...
req(support.get("next_gate")=="support-build-level0","Tier3 support next gate")
...
print("Next gate: support build level 0 (Breeze Icons + KDocTools)")
