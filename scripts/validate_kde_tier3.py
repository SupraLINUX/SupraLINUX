...
for node_id,sha in expected.items():
    ...
    req(planning.get("readiness")=="package-contract-review-pass",f"{node_id}: package-contract review PASS lifecycle")
    ...
    req(planning.get("package_contract")=="review-pass",f"{node_id}: package-contract review PASS")
...
req(policy.get("phase")=="package-contract-decision","Tier3 discovery phase")
...
req(policy.get("package_contracts")=="review-pass-decision-required","Tier3 package-contract gate")
req(policy.get("package_builds")=="not-authorized-before-tier3-package-contract-decision","Tier3 package-build gate")
...
req(support.get("next_gate")=="tier3-package-contract-decision","Tier3 support next gate")
...
req("package-contract-review-pass" in doc,"Tier3 docs lifecycle")
...
print("Next gate: Tier 3 package-contract decision")
