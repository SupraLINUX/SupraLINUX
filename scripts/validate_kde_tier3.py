...
req(policy.get("package_contracts")=="support-contracts-ready","Tier3 package-contract gate")
req(policy.get("package_builds")=="not-authorized-before-support-materialization","Tier3 package-build gate")
...
req(support.get("next_gate")=="support-materialization","Tier3 support next gate")
...
print("Next gate: support-component materialization")
