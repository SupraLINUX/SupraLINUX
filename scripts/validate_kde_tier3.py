...
req(tier3.get("support_components",{}).get("pending")==["breeze-icons","kdoctools","kded"],"Tier3 support-component pending queue")
...
req(policy.get("provider_audit")=="support-components-PASS","Tier3 provider audit gate")
req(policy.get("package_contracts")=="support-components-authorized","Tier3 package-contract gate")
req(policy.get("package_builds")=="not-authorized-before-support-package-contracts","Tier3 package-build gate")
...
req(support.get("next_gate")=="support-contract-reference-capture","Tier3 support next gate")
...
print("Next gate: support-component contract reference capture")
