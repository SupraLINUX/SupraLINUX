...
for node_id,sha in expected.items():
    ...
    req(planning.get("readiness")=="package-contract-ready",f"{node_id}: package-contract ready lifecycle")
    ...
    req(planning.get("package_contract")=="not-materialized",f"{node_id}: package contract not materialized")
...
req(policy.get("phase")=="materialization","Tier3 discovery phase")
...
req(policy.get("package_builds")=="not-authorized-before-tier3-materialization","Tier3 package-build gate")
...
req(support.get("next_gate")=="tier3-materialization","Tier3 support next gate")
...
req("package-contract-ready" in doc,"Tier3 docs lifecycle")
...
print("Next gate: Tier 3 materialization")
