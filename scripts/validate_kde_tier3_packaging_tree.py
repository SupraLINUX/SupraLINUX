...
req(t.get("discovery_policy",{}).get("phase") in {"package-contract-tree-capture","package-contract-tree-pass","package-contract-review","package-contract-decision","materialization"},"canonical Tier3 packaging-tree phase")
