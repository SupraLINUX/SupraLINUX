...
req(t.get("discovery_policy",{}).get("phase") in {"package-contract-tree-capture","package-contract-tree-pass","package-contract-review","package-contract-decision","materialization","build-campaign-planning"},"canonical Tier3 packaging-tree phase")
req(t.get("support_components",{}).get("next_gate") in {"tier3-package-contract-tree-capture","tier3-package-contract-review","tier3-package-contract-decision","tier3-materialization","tier3-build-campaign-planning"},"canonical Tier3 packaging-tree next gate")
