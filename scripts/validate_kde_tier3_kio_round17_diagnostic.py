...
for token in ("10839162922","R17|KDIR","R17|KNEW","KIconUtils::addOverlays","testFolderIconCollection:default","instrumentation.patch"):
...
req("transient diagnostic-only instrumentation patch" in D and "must still reproduce both original failures" in D,"Round17 documentation")
