...
req(tier3.get("support_components",{}).get("next_gate") in {"support-build-level1","tier3-provider-audit","tier3-package-contracts","tier3-build","tier3-package-contract-tree-capture","tier3-package-contract-review","tier3-materialization"},"canonical level1 gate")
