...
req(sum(1 for n in tier1.values() if n.get("state") == "PASS") == 27, "Current Tier 1 PASS count must be 27 after Batch 10 closure")
req(sum(1 for n in tier1.values() if n.get("state") == "pending") == 2, "Current Tier 1 pending count must be 2 after Batch 10 closure")
...
req("27 PASS / 2 pending" in depdoc, "dependency documentation current canonical count")
...
print("Current canonical Tier 1: 27 PASS / 2 pending / 0 FAIL / 0 BLOCKED; Batch 4 historical closure remains 13/16")
