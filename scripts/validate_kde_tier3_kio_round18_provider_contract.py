...
if m.get("status") == "definition-pending-audit":
    ...
    req(m.get("next_gate") == "tier3-round18-kio-test-provider-remediation-materialization-definition", "Round18 PASS historical handoff")
...
print("KDE Tier 3 KIO Round 18 historical provider-contract evidence: PASS")
