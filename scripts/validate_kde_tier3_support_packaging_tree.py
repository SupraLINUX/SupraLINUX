...
req(support.get("next_gate") in {"support-contract-tree-capture","support-contract-review","support-materialization","support-build-level0","support-build-level1"},"canonical packaging-tree next gate")
