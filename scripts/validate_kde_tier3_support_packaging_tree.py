...
req(support.get("next_gate") in {"support-contract-tree-capture","support-contract-review","support-materialization","support-build-level0","support-build-level1","tier3-provider-audit","tier3-package-contracts"},"canonical packaging-tree next gate")
