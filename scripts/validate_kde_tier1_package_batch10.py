...
for token in ('packages/kde/kirigami/*','packages/kde/kquickcharts/*','package_validation_dependencies'):
 req(token in scope or token in workflow,f'Batch10 scope/workflow missing {token}')
