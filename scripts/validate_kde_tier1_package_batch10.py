...
req(len(qinc)==3 and len(inc)==1,'Batch 10 validation-incident ledger mismatch')
if len(inc)==1:
 x=inc[0]
...
req(len(ka)==2 and len(qa)==3,'Batch 10 real-attempt ledger count mismatch')
if len(ka)==2:
 x=ka[0]
