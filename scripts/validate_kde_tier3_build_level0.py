...
if m.get("state")=="active-pending-ci":
    ...
    if ar.get("round")==9:
        req(ar.get("level")=="build-level1" and ar.get("status")=="materialization-pending-ci","Tier3 Level1 round9 source-remediation lifecycle")
        ...
        req(ar.get("next_gate")=="tier3-round9-level1-materialization","Tier3 Level1 round9 materialization gate")
