...
if m.get("state")=="active-pending-ci":
    ...
    if ar.get("round")==10:
        req(ar.get("level")=="build-level1" and ar.get("status") in {"materialization-pending-ci","materialization-PASS-pending-level1-planning-validation","level1-active-pending-ci"},"Tier3 Level1 round10 source-remediation lifecycle")
        ...
        if t.get("discovery_policy",{}).get("package_builds")=="tier3-level1-authorized":
            req(ar.get("status")=="level1-active-pending-ci" and ar.get("execution_authorized") is True and ar.get("level1_execution_authorized") is True,"Tier3 Level1 Attempt6 active authorization")
            req(ar.get("current_attempt")==6 and ar.get("activation_policy_workflow_run")==36032425645 and ar.get("activation_level1_workflow_run")==36032425729,"Tier3 Level1 Attempt6 validation evidence")
            req(ar.get("activation_commit")=="0fee159ac1f24dc160e1edd9976a7708f89d657d" and ar.get("next_gate")=="tier3-build-level1-attempt6","Tier3 Level1 Attempt6 activation gate")
            ...
            req(ar.get("current_attempt")==5 and ar.get("next_attempt")==6,"Tier3 Level1 round10 attempt markers")
            req(ar.get("status")=="materialization-PASS-pending-level1-planning-validation","Tier3 Level1 round10 source PASS state")
            req(ar.get("materialization_workflow_run")==36002910277 and ar.get("materialization_commit")=="c0774e5514fd83995aad3c86e1f6a5b106b001a3","Tier3 Level1 round10 materialization evidence")
            arts=ar.get("materialization_artifacts",{})
            req(arts.get("kio",{}).get("artifact_id")==10809231495 and arts.get("kxmlgui",{}).get("artifact_id")==10808294092,"Tier3 Level1 round10 materialization artifacts")
            req(ar.get("next_gate")=="tier3-build-level1-planning-validation","Tier3 Level1 round10 planning-validation gate")
        else:
            req(ar.get("execution_authorized") is False and ar.get("level1_execution_authorized") is False,"Tier3 Level1 round10 execution pause")
            req(ar.get("current_attempt")==5 and ar.get("next_attempt")==6,"Tier3 Level1 round10 attempt markers")
            req(ar.get("status")=="materialization-pending-ci" and ar.get("next_gate")=="tier3-round10-level1-materialization","Tier3 Level1 round10 materialization gate")
        ...
        if t.get("discovery_policy",{}).get("package_builds")!="tier3-level1-authorized":
            req(ar.get("execution_authorized") is False and ar.get("level1_execution_authorized") is False,"Tier3 Level1 round9 execution pause")
        req(ar.get("validation_workflow_run")==35961584503 and ar.get("validation_commit")=="513cb12a96c7c79ffb5790253504482a56af2e63","Tier3 Level1 Attempt4 evidence")
        req(set(ar.get("remaining_failed_nodes",[]))=={"kio","kxmlgui"} and ar.get("canonical_promotions")==0,"Tier3 Level1 Attempt4 failure/no-promotion semantics")
        if t.get("discovery_policy",{}).get("package_builds")=="tier3-level1-authorized":
            req(ar.get("status")=="level1-active-pending-ci" and ar.get("execution_authorized") is True and ar.get("level1_execution_authorized") is True,"Tier3 Level1 Attempt5 active authorization")
            req(ar.get("current_attempt")==5 and ar.get("activation_policy_workflow_run")==35990068378 and ar.get("activation_level1_workflow_run")==35990068382,"Tier3 Level1 Attempt5 validation evidence")
            req(ar.get("activation_commit")=="45675c1fb5a43f95204c2cf0c5c15df0ef703832" and ar.get("next_gate")=="tier3-build-level1-attempt5","Tier3 Level1 Attempt5 activation gate")
        elif t.get("discovery_policy",{}).get("package_builds")=="tier3-level1-source-PASS-pending-planning-validation":
            req(ar.get("current_attempt")==4 and ar.get("next_attempt")==5,"Tier3 Level1 round9 attempt markers")
            req(ar.get("status")=="materialization-PASS-pending-level1-planning-validation","Tier3 Level1 round9 source PASS state")
            req(ar.get("materialization_workflow_run")==35965579279 and ar.get("materialization_commit")=="8380856c8161dccc9de9c12745012c555baa26b0","Tier3 Level1 round9 materialization evidence")
            req(ar.get("next_gate")=="tier3-build-level1-planning-validation","Tier3 Level1 round9 planning-validation gate")
        else:
            req(ar.get("current_attempt")==4 and ar.get("next_attempt")==5,"Tier3 Level1 round9 attempt markers")
            req(ar.get("status")=="materialization-pending-ci" and ar.get("next_gate")=="tier3-round9-level1-materialization","Tier3 Level1 round9 materialization gate")
        hist8=[x for x in t.get("remediation_history",[]) if x.get("round")==8]
        req(len(hist8)==1 and hist8[0].get("status")=="attempt4-complete-FAIL" and hist8[0].get("validation_workflow_run")==35961584503,"Tier3 Attempt4 closure retained while Level1 round9 remediates")
        hist4=[x for x in t.get("remediation_history",[]) if x.get("round")==4]
        req(len(hist4)==1 and hist4[0].get("status")=="attempt5-complete" and hist4[0].get("canonical_promotions")==11,"Tier3 Level0 Attempt5 closure retained while Level1 round9 remediates")
    elif ar.get("round")==8:
        req(ar.get("level")=="build-level1" and ar.get("status") in {"materialization-pending-ci","materialization-PASS-pending-level1-planning-validation","level1-active-pending-ci"},"Tier3 Level1 round8 source-remediation lifecycle")
        ...
        if t.get("discovery_policy",{}).get("package_builds")=="tier3-level1-authorized":
            req(ar.get("status")=="level1-active-pending-ci" and ar.get("execution_authorized") is True and ar.get("level1_execution_authorized") is True,"Tier3 Level1 Attempt4 active authorization")
            req(ar.get("current_attempt")==4 and ar.get("activation_policy_workflow_run")==35895610944 and ar.get("activation_level1_workflow_run")==35895610937,"Tier3 Level1 Attempt4 validation evidence")
            req(ar.get("activation_commit")=="9f680b0d8790c7bc472e8352e6675d606f706ee7" and ar.get("next_gate")=="tier3-build-level1-attempt4","Tier3 Level1 Attempt4 activation gate")
        elif t.get("discovery_policy",{}).get("package_builds")=="tier3-level1-source-PASS-pending-planning-validation":
