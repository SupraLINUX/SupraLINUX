...
req(sc.get("next_gate") in {"support-package-contracts","support-contract-reference-capture","support-contract-tree-capture","support-contract-review","support-materialization","support-build-level0","support-build-level1"},"Tier3 support contract next gate")
