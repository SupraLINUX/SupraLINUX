...
req(nodes["kio"].get("state")=="FAIL" and nodes["kio"].get("packaging",{}).get("package_version")=="6.30.0-0supralinux7","Round14 retains KIO -7 FAIL")
...
req(L.get("next_gate")=="tier3-round14-kio-kiconthemes-engine-provider-diagnostic-definition","Round14 current live gate")
...
kd=DAG.get("nodes",{}).get("kiconthemes",{})
req(kd.get("state")=="PASS" and kd.get("package_version")=="6.30.0-0supralinux3","KIconThemes canonical PASS")
req(any(x.get("artifact_id")==10731249726 and x.get("artifact_sha256")=="5b06a92638fb67409710b140f3ebc597400d0d739db497e3d570fbe42cfa5206" for x in kd.get("evidence",[])),"KIconThemes canonical artifact evidence")
...
print("KDE Tier 3 KIO Round 14 diagnostic definition: PASS")
