...
for p in "${changed[@]}"; do
  case "${p}" in
    packages/kde/${NODE}/*|scripts/run-kde-tier1-package-batch10-preflight.sh|scripts/kde-tier1-package-batch10-needed.sh|.github/workflows/kde-tier1-package-batch10.yml)
      exit 0 ;;
  esac
