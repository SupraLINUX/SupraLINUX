...
req(t.get("discovery_policy",{}).get("phase") in {"package-contract-review","package-contract-review-pass","package-contract-decision","materialization","build-campaign-planning"},"Tier3 canonical review phase")
req(t.get("support_components",{}).get("next_gate") in {"tier3-package-contract-review","tier3-package-contract-decision","tier3-materialization","tier3-build-campaign-planning"},"Tier3 canonical review next gate")
