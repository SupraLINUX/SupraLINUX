...
req(support.get("next_gate") in {"support-materialization","support-build","support-build-level0","support-build-level1","tier3-provider-audit","tier3-package-contracts","tier3-package-contract-tree-capture","tier3-package-contract-review","tier3-package-contract-decision","tier3-materialization","tier3-build-campaign-planning","tier3-build-level0"},"canonical support materialization gate")
