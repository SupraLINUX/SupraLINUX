...
for node_id in canonical:
    ...
    if a.get("status")=="PASS":
        req(planning.get("readiness") in {"package-contract-required","package-contract-reference-pending","package-contract-reference-pass","package-contract-tree-pending","package-contract-tree-pass","package-contract-review-pending","package-contract-review-pass","package-contract-decision-pending","package-contract-ready","materialized","PASS","retained-pass","runtime-validation-required"},f"{node_id}: post-audit readiness")
        req(planning.get("package_contract") in {"required","reference-capture-pending","reference-capture-pass","packaging-tree-pending","packaging-tree-pass","review-pending","review-pass","ready","not-materialized","materialized","PASS","retained-pass","runtime-validation-required"},f"{node_id}: package contract post-audit lifecycle")
        req(planning.get("provider")=="supralinux",f"{node_id}: SupraLINUX provider selection")
        req(planning.get("package_contract") in {"required","reference-capture-pending","reference-capture-pass","packaging-tree-pending","packaging-tree-pass","review-pending","review-pass","ready","not-materialized","materialized","PASS","retained-pass","runtime-validation-required"},f"{node_id}: post-audit package-contract lifecycle")
