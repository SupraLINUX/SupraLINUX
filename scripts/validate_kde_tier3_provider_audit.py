...
for node_id in canonical:
    ...
    req(planning.get("readiness") in {"dependency-graph-ready","package-contract-required","package-contract-reference-pending","package-contract-reference-pass","package-contract-tree-pending","package-contract-tree-pass","package-contract-review-pending","package-contract-review-pass","package-contract-ready","materialized","PASS"},f"{node_id}: provider-audit readiness lifecycle")
    ...
    if a.get("status")=="PASS":
        req(planning.get("readiness") in {"package-contract-required","package-contract-reference-pending","package-contract-reference-pass","package-contract-tree-pending","package-contract-tree-pass","package-contract-review-pending","package-contract-review-pass","package-contract-ready","materialized","PASS"},f"{node_id}: post-audit readiness")
